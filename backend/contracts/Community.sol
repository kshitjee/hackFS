...
contract Community is Ownable {
  ...
  /* STATE VARIABLES */
  address immutable collectionImplemenation;
  ...
  /* CONSTRUCTOR */
  constructor(address _collectionImplemenation) {
  ...
  /* GETTERS */
  function getCollection(address _collectionAddress) public view returns(Collection memory) {
